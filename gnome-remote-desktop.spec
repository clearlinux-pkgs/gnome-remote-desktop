...
Version  : 46.5
Release  : 24
URL      : https://gitlab.gnome.org/GNOME/gnome-remote-desktop/-/archive/46.5/gnome-remote-desktop-46.5.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/gnome-remote-desktop/-/archive/46.5/gnome-remote-desktop-46.5.tar.gz
...
%prep
%setup -q -n gnome-remote-desktop-46.5
cd %{_builddir}/gnome-remote-desktop-46.5
pushd ..
cp -a gnome-remote-desktop-46.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726355248
