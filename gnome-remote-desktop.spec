...
Version  : 47.1
Release  : 25
URL      : https://gitlab.gnome.org/GNOME/gnome-remote-desktop/-/archive/47.1/gnome-remote-desktop-47.1.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/gnome-remote-desktop/-/archive/47.1/gnome-remote-desktop-47.1.tar.gz
...
%prep
%setup -q -n gnome-remote-desktop-47.1
cd %{_builddir}/gnome-remote-desktop-47.1
pushd ..
cp -a gnome-remote-desktop-47.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729535850
