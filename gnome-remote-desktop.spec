...
Version  : 45.1
Release  : 11
URL      : https://gitlab.gnome.org/GNOME/gnome-remote-desktop/-/archive/45.1/gnome-remote-desktop-45.1.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/gnome-remote-desktop/-/archive/45.1/gnome-remote-desktop-45.1.tar.gz
...
%prep
%setup -q -n gnome-remote-desktop-45.1
cd %{_builddir}/gnome-remote-desktop-45.1
pushd ..
cp -a gnome-remote-desktop-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701961162
...
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dfdk_aac=false \
-Dvnc=true  builddir
ninja -v -C builddir
